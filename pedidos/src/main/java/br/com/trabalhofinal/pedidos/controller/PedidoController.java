package br.com.trabalhofinal.pedidos.controller;

import br.com.trabalhofinal.pedidos.dto.PedidoDto;
import br.com.trabalhofinal.pedidos.dto.StatusDto;
import br.com.trabalhofinal.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        @GetMapping("/{id}")
        public ResponseEntity<PedidoDto> listarPorId(@PathVariable @NotNull Integer id) {
        ...
        public ResponseEntity<PedidoDto> atualizaStatus(@PathVariable Integer id, @RequestBody StatusDto status) throws Exception {
        ...
        @PutMapping("/{id}/pago")
        public ResponseEntity<Void> aprovaPagamento(@PathVariable @NotNull Integer id) throws Exception {
